...
class Settings():
    ...
    DATA_URI  = os.getenv('DATABASE_URI', "mongodb+srv://erenyeagermikasa84:pkbOXb3ulzi9cEFd@cluster0.ingt8mt.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
    DATA_NAME = os.getenv('DATABASE_NAME', "Cluster0")
